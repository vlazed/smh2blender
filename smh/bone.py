...
class GenericBoneField:
    ...
    def __init__(self, armature: ArmatureObject, data: GenericBoneDict, angle_offset: Euler = Euler()):
...
class PhysBoneField(GenericBoneField):
    ...
    def __init__(self, armature: ArmatureObject, data: PhysBoneDict, angle_offset: Euler):
...
class BoneField(GenericBoneField):
    ...
    def __init__(self, armature: ArmatureObject, data: BoneDict):
